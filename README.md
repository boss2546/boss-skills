...
- **🧱 Host Firewall (UFW):** สูตรเปิดรั้วกำแพงเซิร์ฟเวอร์ เฉพาะพอร์ต 22 (SSH), 80 (HTTP), 443 (HTTPS) ปิดพอร์ตอื่นๆ ทั้งหมด ปลอดภัย 100%
- **☁️ Cloudflare & Custom Domain:** วิธีเปิดเว็บออกสู่สายตาชาวโลกด้วยชื่อโดเมนตัวเอง ซ่อน IP จริงหลังก้อนเมฆสีส้ม (Proxied) หรือเจาะท่อปลอดภัยด้วย Cloudflare Tunnel
